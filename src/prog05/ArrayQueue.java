...
public class ArrayQueue<E> extends AbstractQueue<E>
    ...
    /**
     * Removes the entry at the fir,st of the queue and returns it
...
//	    ///
		if(count==0){
			returnValue = theElements[(first+count) % theElements.length];
    ...
    /**
     * Double the capacity and reallocate the elements.b
